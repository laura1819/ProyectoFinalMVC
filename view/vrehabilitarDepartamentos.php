<nav class="navbar navbar-expand-lg bg-secondary fixed-top text-uppercase" id="mainNav">
    <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">Rehabilitar Departamento</a>
        ...
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
            ...
            <header class="masthead bg-primary text-white text-center">
                <div id="login">
                    <h3 class="text-center text-white pt-10">Rehabilitar el departamento</h3><br>
                    <div class="container">
